...
class Game:
    def __init__(self):
        ...
        # audio
        self.level_bg_music = pygame.mixer.Sound('./Knight Scroll Game/audio/level_music.wav')
        self.overworld_bg_music = pygame.mixer.Sound(
            './Knight Scroll Game/audio/overworld_music.wav')
...
background = pygame.image.load("./Knight Scroll Game/graphics/decoration/Background_01.png")
about_screen_img = pygame.image.load("./Knight Scroll Game/graphics/decoration/About.png")
